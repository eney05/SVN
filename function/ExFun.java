...
// массивы строковых чисел	
	...
	// получаем строку с прописью числа
...
// собственно функция поиска и выбора
...
/*	
	расстояние между двумя точками в двумерном декартовом пространстве
